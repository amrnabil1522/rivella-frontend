...
const CalendarDay = styled(Box)(
  ({ theme, isDisabled, isSelected, isToday }) => ({
    width: "40px",
    height: "40px",
    display: "flex",
    alignItems: "center",
    ...
    const fetchChaletDetails = async () => {
      try {
        ...
        if (response.data.success) {
          ...
          if (
            response.data.data.reservedPeriods &&
            response.data.data.reservedPeriods.length > 0
          ) {
            const disabled = [];
    ...
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      >
        <Fade in={openImageModal}>
          ...
          >
            <ModalImage src={allImages[modalImageIndex]} alt={chalet.name} />
            <CloseButton onClick={() => setOpenImageModal(false)}>
              <CloseIcon />
            </CloseButton>
              ...
              <Grid item xs={6}>
                ...
                >
                  <CalendarMonthIcon
                    sx={{
                      mr: 1,
                      color: startDate ? "primary.main" : "text.disabled",
                    }}
                  />
                  <Box>
                    <Typography
          ...
          {totalNights > 0 && (
            <Box mb={3}>
              <Box display="flex" justifyContent="space-between" mb={1}>
                ...
                <Typography variant="body1">{totalPrice} جنية</Typography>
              </Box>
              <Divider sx={{ my: 2 }} />
